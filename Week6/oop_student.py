    ...
    def grade(self):
        if self.score >= 5:
            print("คุณสอบผ่าน")
             ...
             print("คุณสอบตก")
std1 = Student(ชื่อ="ณภัทรพงศ์ จิตพิชัย",ชื่อเล่น="คิว",คะแนนสอบ=0)
std1.score0()
print(std1.name,std1.nickname,std1.score , std1.grade)
print("-------------------------------------------------------------------------")
...
std3.grade()
print("-------------------------------------------------------------------------")
std4 = Student(ชื่อ="ณัฐพงศ์ ศรีเทพย์",ชื่อเล่น="นาย",คะแนนสอบ=0)
std4.score0()
